#ifndef _ROS_ntbd_msgs_Motors_Array_h
#define _ROS_ntbd_msgs_Motors_Array_h
...
namespace ntbd_msgs
{
  ...
  class Motors_Array : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "ntbd_msgs/Motors_Array"; };
